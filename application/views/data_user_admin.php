	     ...
	     <div class="container">
	        <div class="row">
	           ...
	           <ul class="nav navbar-nav navbar-right">
				<li><a href=""> Halo,<?php foreach ($user_list as $data) {?> <?php echo $data['nama']; ?> <?php }?></a></li>
                ...
                <table class="table table-striped">
                      ...
                      <tbody>
                        ...
                        <tr>
                          ...
                          <!-- <td class="text-center"><a href="<?php echo base_url('index.php/data_user/update/' .$key['id_user']) ?>" class="btn btn-primary">Edit</a> -->
