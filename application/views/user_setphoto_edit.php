...
<body>
  ...
  <div class="container" style="background-color: #F8F8FF">
    ...
    <div class="page-header" style="color:black">
      <h1 class="text-center">Edit Info Foto</h1>
    </div>
    ...
    <div class="form-group">
      ...
      <!-- TAMPIL FOTO -->
      <center>
        <?php $id=1; foreach ($photo_edit as $ay) : ?>
          <img src="<?php echo base_url('assets/images/foto/').$ay['photo'] ?>"  style="width:30%">
        <?php $id++; endforeach?>
      </center><br> 

      <!-- FORM EDIT -->
      <label for="">Judul</label>
      <input type="text" class="form-control" id="judul" name="judul" value="<?php echo $user_photo[0]->judul ?>">
      <br>
      ...
      <input type="text" class="form-control" id="deskripsi" name="deskripsi" value="<?php echo $user_photo[0]->deskripsi ?>">
      <br>

      <center>
        <button type="Submit" class="btn btn-primary">Edit</button>
        <?php echo form_close(); ?>
        <a href="<?php echo base_url('index.php/user_setphoto')?>" class="btn btn-danger">Kembali</a>
      </center>
