	    ...
	    <div class="col-md-4">
	      <div class="thumbnail">
	        <a href="<?php echo base_url('assets/images/foto/').$key['photo'] ?>" target="_blank">
	          ...
	          <div class="caption">
				<div class="judulfoto">
					<a href="<?php echo base_url('index.php/user_komen/user/').$key['id_foto'] ?>" class="btn btn-success">Lihat Komentar</a>
					<a href="<?php echo base_url('index.php/user_setphoto/update/').$key['id_foto'] ?>" class="btn btn-warning">Edit</a>
          			<a href="<?php echo base_url('index.php/user_setphoto/delete/').$key['id_foto'] ?>" class="btn btn-danger">Hapus</a>
          			<br><br><?php echo $key['judul'] ?><br><br>
	        	</div>
	          	<p>
